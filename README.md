...
Для вычисления площади круга нужно использовать метод CalculateCircle. Он принимает радиус круга в качестве параметра и возвращает площадь.
...
Для вычисления площади треугольника нужно использовать метод CalculateTriangleArea. Он принимает длины трех сторон треугольника в качестве параметров и возвращает площадь.
